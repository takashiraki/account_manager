...
<div class="row mt-5">
    <div class="col-2">
        <ul class="sidebar">
            ...
            <li><a class="btn btn btn-outline-primary btn-lg" role="button" aria-disabled="true" href="">Account</a></li>
            <li><a class="btn btn btn-outline-primary btn-lg" role="button" aria-disabled="true" href="">User</a></li>
            <li><a class="btn btn btn-outline-primary btn-lg" role="button" aria-disabled="true" href="">Loan</a></li>
        </ul>
    </div>
    <div class="col-7">
